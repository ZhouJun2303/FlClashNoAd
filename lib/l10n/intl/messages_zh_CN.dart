...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "noAdAboutSourceDesc": MessageLookupByLibrary.simpleMessage(
      "NoAd 基于 GPL-3.0 修改 FLClash，并增加 Android 广告域名拦截和 anti-AD 规则。",
    ),
    "noAdAboutSourceTitle": MessageLookupByLibrary.simpleMessage(
      "基于 FLClash v0.8.94",
    ),
    "noAdAdBlocking": MessageLookupByLibrary.simpleMessage("广告拦截"),
    "noAdAdBlockingDesc": MessageLookupByLibrary.simpleMessage(
      "通过 VPN/TUN 规则层拦截已知广告和追踪域名。",
    ),
    "noAdAllowDomain": MessageLookupByLibrary.simpleMessage("放行域名"),
    "noAdAllowExactDomain": MessageLookupByLibrary.simpleMessage("放行精确域名"),
    "noAdAllowedExactDomains": MessageLookupByLibrary.simpleMessage("已放行精确域名"),
    "noAdBlockDomain": MessageLookupByLibrary.simpleMessage("阻断域名"),
    "noAdBlockDomainSuffix": MessageLookupByLibrary.simpleMessage("阻断域名后缀"),
    "noAdBlockExactDomain": MessageLookupByLibrary.simpleMessage("阻断精确域名"),
    "noAdBlockSuffix": MessageLookupByLibrary.simpleMessage("阻断后缀"),
    "noAdBlocked": MessageLookupByLibrary.simpleMessage("已拦截"),
    "noAdBlockedDomainSuffixes": MessageLookupByLibrary.simpleMessage(
      "已阻断域名后缀",
    ),
    "noAdBlockedEvents": MessageLookupByLibrary.simpleMessage("拦截事件"),
    "noAdBlockedExactDomains": MessageLookupByLibrary.simpleMessage("已阻断精确域名"),
    "noAdBypassApp": MessageLookupByLibrary.simpleMessage("绕过 App"),
    "noAdBypassAppPackage": MessageLookupByLibrary.simpleMessage("绕过 App 包名"),
    "noAdBypassedAppPackages": MessageLookupByLibrary.simpleMessage(
      "已绕过 App 包名",
    ),
    "noAdConfirmSuffixBlocking": MessageLookupByLibrary.simpleMessage("确认后缀阻断"),
    ...
    "noAdDetailedMihomoLogsDesc": MessageLookupByLibrary.simpleMessage(
      "临时把生成配置切换到 debug 日志，日志仅保留在内存中。",
    ),
    "noAdDomainRequired": MessageLookupByLibrary.simpleMessage("域名不能为空"),
    "noAdExportDiagnostics": MessageLookupByLibrary.simpleMessage("导出诊断"),
    "noAdExportRawBlockedEvents": MessageLookupByLibrary.simpleMessage(
      "导出原始拦截事件",
    ),
    "noAdExportRawJsonl": MessageLookupByLibrary.simpleMessage("导出原始 JSONL"),
    "noAdExportSaved": MessageLookupByLibrary.simpleMessage("导出已保存"),
    "noAdFallbackRulesLoaded": MessageLookupByLibrary.simpleMessage(
      "远程更新失败，已加载内置 anti-AD 兜底规则。",
    ),
    "noAdFilterAll": MessageLookupByLibrary.simpleMessage("全部"),
    "noAdFilterApp": MessageLookupByLibrary.simpleMessage("App"),
    "noAdFilterDomain": MessageLookupByLibrary.simpleMessage("域名"),
    "noAdInMemoryEvents": MessageLookupByLibrary.simpleMessage("内存事件"),
    "noAdInvalidDomain": MessageLookupByLibrary.simpleMessage("无效域名"),
    "noAdInvalidDomainSuffix": MessageLookupByLibrary.simpleMessage("无效域名后缀"),
    "noAdLastRuleUpdate": MessageLookupByLibrary.simpleMessage("上次规则更新"),
    "noAdManualRules": MessageLookupByLibrary.simpleMessage("手动规则"),
    "noAdMatchedNoAdRule": MessageLookupByLibrary.simpleMessage("命中 NoAd 规则"),
    "noAdNoAllowlistDomains": MessageLookupByLibrary.simpleMessage("没有放行域名"),
    "noAdNoBlockedEvents": MessageLookupByLibrary.simpleMessage("内存中没有拦截事件"),
    "noAdNoBlockedEventsDesc": MessageLookupByLibrary.simpleMessage(
      "事件仅在 VPN/核心会话活动期间保留。",
    ),
    "noAdNoBypassedApps": MessageLookupByLibrary.simpleMessage("没有绕过 App"),
    "noAdNoFilteredEvents": MessageLookupByLibrary.simpleMessage("没有事件匹配当前筛选"),
    ...
    "noAdNoNoAdMatch": MessageLookupByLibrary.simpleMessage("未命中 NoAd 规则"),
    "noAdNoSuffixBlockDomains": MessageLookupByLibrary.simpleMessage(
      "没有后缀阻断域名",
    ),
    "noAdOverview": MessageLookupByLibrary.simpleMessage("概览"),
    "noAdPrivacyNotice": MessageLookupByLibrary.simpleMessage(
      "NoAd 不安装 CA 证书，也不解密 HTTPS。HTTPS 记录仅展示域名、IP、端口、App 和规则元数据。",
    ),
    "noAdRawExportWarning": MessageLookupByLibrary.simpleMessage(
      "原始 JSONL 包含被拦截域名、目标 IP/端口、包名、UID 和规则元数据。不包含 URL、请求头或流量内容。仅在你确实准备分享这些值时导出。",
    ),
    "noAdRuleActions": MessageLookupByLibrary.simpleMessage("规则操作"),
    "noAdRuleVersion": MessageLookupByLibrary.simpleMessage("规则版本"),
    "noAdRules": MessageLookupByLibrary.simpleMessage("规则"),
    "noAdRulesUpdateFailed": MessageLookupByLibrary.simpleMessage(
      "NoAd 规则更新失败",
    ),
    "noAdRulesUpdated": MessageLookupByLibrary.simpleMessage("NoAd 规则已更新"),
    "noAdSearchBlockedEvents": MessageLookupByLibrary.simpleMessage("搜索拦截事件"),
    "noAdSearchBlockedEventsDesc": MessageLookupByLibrary.simpleMessage(
      "可按全部字段、域名或 App 包名过滤。",
    ),
    "noAdSessionBlocked": MessageLookupByLibrary.simpleMessage("本次会话拦截"),
    "noAdTest": MessageLookupByLibrary.simpleMessage("测试"),
    "noAdTestDomain": MessageLookupByLibrary.simpleMessage("测试域名"),
    "noAdToolsDesc": MessageLookupByLibrary.simpleMessage("广告拦截、拦截事件和规则控制"),
    "noAdTotalBlocked": MessageLookupByLibrary.simpleMessage("累计拦截"),
    "noAdUnknownHost": MessageLookupByLibrary.simpleMessage("<未知域名>"),
    "noAdUpdateRemoteRules": MessageLookupByLibrary.simpleMessage("更新远程规则"),
    "noAdUpstreamFLClash": MessageLookupByLibrary.simpleMessage("上游 FLClash"),
